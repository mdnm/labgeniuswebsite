...
<div class="login-cont-form animate-fast fadeInUpCenter">
    <div class="flat-form-header">
        <div class="form-header-btn-left active-btns">
            <h2 class="form-title">aluno</h2>
        </div>
        <div class="form-header-btn-right">
            <h2 class="form-title">instrutor</h2>
        </div>
    </div>
    <div id="aluno" class="flat-form-body">
        <form class="flat-form animate-fast fadeIn" method="post" action="php/valida.php">
    ...
    <div id="instructor" class="flat-form-body">
        <form class="flat-form animate-fast fadeIn" method="post" action="php/validainstructor.php">
            <input class="flat-form-input" id="user" type="text" name="user" placeholder="USUÁRIO"/>
            <input class="flat-form-input" id="passwd" type="password" name="passwd" placeholder="SENHA"/>
            <?php
                ...
                if(!empty($_SESSION['aut_error2'])){
                    echo $_SESSION['aut_error2'];
                    unset($_SESSION['aut_error2']);
                }
            ?>
            <input class="flat-form-button" type="submit" value="ENTRAR"/>
            <p class="flat-form-message">Como assim você não tem conta? <a href="cadastro.php">Crie uma.</a></p>
